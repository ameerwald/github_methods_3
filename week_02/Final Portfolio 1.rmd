...
Perhaps m1 is a little bit better, because it has sooo many points right on the line
...
Separate intercepts for subjects are needed due to individual differences in baseline pitch and separate intercepts for scenarios are needed as we can't directly compare across all polite conditions as the scenarios vary drastically and affect the participants in different ways. Adding the intercept should explain more variance.
  
#### iv. describe the variance components of the second level (if any) 

WE SHOULD PROBABLY SAY MORE HERE THAN JUST THE SUMMARY RIGHT?

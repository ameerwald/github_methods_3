...
# switched 251 to 682 b/c thats the number of repititons 
for i in range(682):
...
# this way screws up the order 
#data_1_2 =  np.concatenate((data[pas1], data[pas2]), axis=0) # 3D
data_1_2.shape
...
len(y_1_2)      
##@ Unsure if this loop is working correctly/getting us what we need...
...
# penalty = L1 (lamda 1) penalizing for large coefficients, solver = 'liblinear' works with L1 and L2
```
